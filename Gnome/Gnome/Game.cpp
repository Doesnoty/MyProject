...
void Game::menu() {
	...
	while (isMenu)
	{
		...
		{
			if (menuIndex == 0) { menuChoice = 0; menuIndex = 0; refresMenu = true; }
			if (menuIndex == 1) { menuChoice = 1; menuIndex = 0; refresMenu = true; }
			if (menuIndex == 2) { menuChoice = 2; menuIndex = 1; refresMenu = true; }
			if (menuIndex == 3) { menuChoice = 3; menuIndex = 2; refresMenu = true; }
		}

		if ((GetAsyncKeyState(VK_DOWN) & 1) || (GetAsyncKeyState(0x53) & 1))
		{
			if (menuIndex == 3) { menuChoice = 3; menuIndex = 3; refresMenu = true; }
			if (menuIndex == 2) { menuChoice = 3; menuIndex = 3; refresMenu = true; }
			if (menuIndex == 1) { menuChoice = 2; menuIndex = 2; refresMenu = true; }
			if (menuIndex == 0) { menuChoice = 1; menuIndex = 1; refresMenu = true; }
